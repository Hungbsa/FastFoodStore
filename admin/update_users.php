...
if(isset($_POST['submit'] ))
{
    if(empty($_POST['uname']) ||
		...
		empty($_POST['phone']))
		{
            ...
            <strong>All fields Required!</strong></div>';
		}
	else{
    if(!filter_var($_POST['email'], FILTER_VALIDATE_EMAIL))
    {
       	$error = '<div class="alert alert-danger alert-dismissible fade show">
        <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <strong>Sai email</strong></div>';
    }
	elseif(strlen($_POST['password']) < 6)
	{
		$error = '<div class="alert alert-danger alert-dismissible fade show">
        <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <strong>Mật khẩu phải nhiều hơn 6 kí tự hoặc số !</strong></div>';
	}
	elseif(strlen($_POST['phone']) < 10)
	{
		$error = '<div class="alert alert-danger alert-dismissible fade show">
        <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <strong>sai số điện thoại!</strong></div>';}
	else{
							  ...
							  <?php $ssql ="select * from users where u_id='$_GET[user_upd]'";
                                ...
                                <form action='' method='post'  >
                                    ...
                                    <div class="form-actions">
                                        ...
                                        <a href="all_users.php" class="btn btn-inverse">Huỷ</a>
                                    </div>
                                </form>
                            </div>
                        </div>
